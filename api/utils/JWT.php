...
class JWT
{
    ...
    public function __construct()
    {
        $this->headers = [
            ...
            'aud' => 'token@westore.ge' // token audience
        ];
        $this->secret = 'thisIsASecretKey'; // this is my secret code
    }
    ...
    public function generate(array $payload): string
    {
        ...
        $payload["exp"] = time() + 86400;                       //  add expiration to payload
    ...
    public function is_valid(string $jwt): int
    {
        ...
        if ((json_decode($payload)->exp - time()) < 0) {
            return false; // fails if expiration is greater than 0, setup for 1 day
        }
